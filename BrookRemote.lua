...
local blacklist = {"EasterEggHuntFolder","NoCarsRegions011","NoCarsRegions","TempThemes","DefaultChatSystemChatEvents","PlayersStartup","SingleVehicles","MotelRegions","UiClone","ClonedTools","BannedLots","AvatarEditorScipts"}
function FindFolder()
